...
describe('Message Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should be able to save a new message', function (done) {
      var _message1 = new Messages(message1);

      _message1.save(function (err) {
        should.not.exist(err);
        _message1.remove(function (err) {
          should.not.exist(err);
          done();
        });
      });
    ...
    it('should fail to save an existing message again', function (done) {
